...
public class UsuariosPanelDatosPersonales extends JPanel {
	...
	public UsuariosPanelDatosPersonales(String dni, String nombre, String apellidos,String direccion,String poblacion, String provincia, String cp, String telefono, String email, String fechanac,String pass){
		super();
		this.dni = dni;
		this.nombre = nombre;
