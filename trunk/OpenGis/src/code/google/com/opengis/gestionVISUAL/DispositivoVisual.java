...
/**
 * @author Iván Serrano y Jose Alapont Clase que genera una ventana interior en
 *         el formulario MDI. Esta ventana es la encargada de gestionar los
 *         Dispositivos.
 * 
 */
...
public class DispositivoVisual extends JInternalFrame {
	...
	private static String[] criterio = { "Iddispositivo", "Modelo",
			"Num_Serie", "Disponible", "Activo" };
	...
	static Object[] nombreColumna = { "Id Dispositivo", "Modelo",
			"Numero Serie", "Disponible", "Activo" };
		...
		cmdNuevoDispositivo
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent e) {
						...
						cargarNuevoDispositivo(panelDispositivoCrear);
						// calculo el nuevo ID de dispositivo
						txtIddispositivo.setText(DispositivoDAO
								.calcularNuevoID() + "");
	 ...
	 * @param modificar
	 *            Indica si vamos a modificar el dispositivo (true) o vamos a
	 *            crear uno nuevo (false)
	 */
		...
		cmdAceptarAlta.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				if (Dispositivo.validarDatos(txtModelo.getText(),
					...
					try {
						numID = (txtIddispositivo.getText()).toString();
						paso2 = true;
					} catch (Exception e1) {
						JOptionPane
								.showMessageDialog(null,
	...
	private JScrollPane getJScrollPaneTablaDispositivos() {
		if (jScrollPaneTablaDispositivo == null) {
			...
			jScrollPaneTablaDispositivo
					.setViewportView(getJTablaDispositivos());
		}
		return jScrollPaneTablaDispositivo;
	}

	/**
	 * This method initializes jTableDispositivos
	 * 
	...
	public static void actualizar() {
		...
		try {
			...
			ResultSet rs = DispositivoDAO.buscarDispositivo(jCmbCriterio
